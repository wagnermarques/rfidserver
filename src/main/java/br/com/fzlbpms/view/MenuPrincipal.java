...
public class MenuPrincipal {
    ...
    public static MenuBar getInstance(){
        ...
        MenuItem mnuItem_UsuarioDoSistema_EXCLUIR = barItem_UsuarioDoSistema.addItem("Excluir (em desenvolvimento)",null,null);
        MenuItem mnuItem_UsuarioDoSistema_PESQUISAR = barItem_UsuarioDoSistema.addItem("Pesquisar  (em desenvolvimento)",null,null);
        
        //Pessoa
        MenuItem mnuItem_Pessoa_INSERIR = barItem_Pessoa.addItem("Inserir  (em desenvolvimento)",null,null);
